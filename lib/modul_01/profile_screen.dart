          ...
          child: Column(
            ...
            children: [
                  ...
                  child: Column(
                    children: [
                      ...
                      _InfoRow(
                        ...
                        label: 'Semester / ',
                        value: 'Semester 3 (2025/2029)',
                      ),
                      Divider(height: 24, color: Color(0xFFF1F5F9)),
                      _InfoRow(
                        icon: Icons.code_rounded,
                        label: 'Akun Github',
                        value: 'github.com/adammarchelino',
                      ),
                      Divider(height: 24, color: Color(0xFFF1F5F9)),
                      _InfoRow(
                        icon: Icons.psychology_rounded,
                        label: 'Minat Rekayasa',
                        value: 'AI, Data, Automation, Front-End',
                      ),
                    ],
                  ),
                ),
              ...
              ElevatedButton.icon(
                onPressed: () async {
                  final Uri url =
                      Uri.parse('https://github.com/adammarchelino');
