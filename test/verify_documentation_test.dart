  ...
  group('Autograding Dokumentasi & Identitas Mahasiswa', () {
    test('1. File README.md telah diisi dengan identitas asli mahasiswa', () {
      ...
      expect(
        ...
        isFalse,
        reason:
            'Placeholder NIM belum diganti dengan NIM Asli Anda di file README.md.',
      );
      expect(
        content.contains('Nama Lengkap Anda') ||
            content.contains('Mahasiswa TRPL Poliwangi'),
        isFalse,
        reason:
            'Placeholder Nama belum diganti dengan Nama Lengkap Anda sendiri di file README.md.',
      );
    });
  });
}
